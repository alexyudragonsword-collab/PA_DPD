...
_EN = {
    ...
    "IQ 增益失衡(dB)": "IQ gain imbalance (dB)",
    "DLA(神经 DPD)需要 torch,在 Android 上不可用;此处只有 ILA。":
        "DLA (neural DPD) needs torch, which is unavailable on Android; "
        "only ILA is offered here.",
    "主题": "Theme",
    "用户手册": "User Manual",
    "目录": "Contents",
    "章节": "Chapter",
